    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Open', 'Open - currently active'), ('Merged', 'Merged - superseded by another cart'), ('Saved', 'Saved - for items to be purchased later'), ('Frozen', 'Frozen - the cart cannot be modified and is in checkout.'), ('Submitted', 'Submitted - has completed checkout process, but not paid'), ('Paid', 'Paid - user has paid'), ('Completed', 'Complete - order has been delivered/picked up/etc'), ('Cancelled', 'Cancelled - Order was cancelled')], default='Open', max_length=128, verbose_name='Status')),
                ...
                ('final_tax_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('final_tax', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=19, null=True)),
                ('final_ship_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('final_ship', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=19, null=True)),
                ('final_digital_tax_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('final_digital_tax', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=19, null=True)),
                ('final_physical_tax_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('final_physical_tax', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=19, null=True)),
                ('cash_paid_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('cash_paid', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=19, null=True)),
                ('total_paid_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ...
                ('postage_paid_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_to_pay_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_unit_at_submit_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='XYZ', editable=False, max_length=3)),
                ('price_per_unit_at_submit', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=19, null=True)),
                ('price_per_unit_override_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='XYZ', editable=False, max_length=3)),
                ('price_per_unit_override', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=19, null=True)),
                ('tax_per_unit_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='XYZ', editable=False, max_length=3)),
