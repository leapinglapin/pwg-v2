    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_price_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default=None, editable=False, max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publisher_sku', models.CharField(blank=True, max_length=30, null=True)),
                ('publisher_short_sku', models.CharField(blank=True, help_text='GW Short Code', max_length=10, null=True)),
                ...
                ('contains_product', models.ForeignKey(blank=True, help_text='If this item contains a multiple of another product, list it here', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contained_in', to='shop.product')),
                ...
                ('primary_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='images.image')),
                ('publisher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.publisher')),
                ('replaced_by', models.ForeignKey(blank=True, help_text='If there is a  newer version of this product, reference it here', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replaces', to='shop.product')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='checkout.checkoutline')),
